...
const LogoutConfirm = ({ data }) => {
  ...
  return (
    <div className="fixed top-0 left-0 h-full w-full bg-blackTransparent flex justify-center items-center pt-7 z-30">
      <div className="w-8/12 sm:w-5/12 lg:w-3/12 bg-dialogColor shadow-md shadow-dark p-10 rounded-md">
